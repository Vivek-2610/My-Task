...
$('.switch').click(function(){
  if ($(".light-background")[0]){
    $('.light-background').addClass("dark-background").removeClass('light-background');
} else {
  $('.dark-background').addClass("light-background").removeClass('dark-background');
}

if ($(".light-text")[0]){
  $('.light-text').addClass("dark-text").removeClass('light-text');
} else {
$('.dark-text').addClass("light-text").removeClass('dark-text');
}

if ($(".light-dark-text")[0]){
  $('.light-dark-text').addClass("dark-light-text").removeClass('light-dark-text');
} else {
$('.dark-light-text').addClass("light-dark-text").removeClass('dark-light-text');
}

if ($(".ac-title-light-bg")[0]){
  $('.ac-title-light-bg').addClass("ac-title-dark-bg").removeClass('ac-title-light-bg');
} else {
$('.ac-title-dark-bg').addClass("ac-title-light-bg").removeClass('ac-title-dark-bg');
}

if ($(".tab-light-bg")[0]){
  $('.tab-light-bg').addClass("tab-dark-bg").removeClass('tab-light-bg');
} else {
$('.tab-dark-bg').addClass("tab-light-bg").removeClass('tab-dark-bg');
}

if ($(".grid-light-border")[0]){
  $('.grid-light-border').addClass("grid-dark-border").removeClass('grid-light-border');
} else {
$('.grid-dark-border').addClass("grid-light-border").removeClass('grid-dark-border');
}

if ($(".ac-light-border")[0]){
  $('.ac-light-border').addClass("ac-dark-border").removeClass('ac-light-border');
} else {
$('.ac-dark-border').addClass("ac-light-border").removeClass('ac-dark-border');
}
...
// if ($(".primary-text")[0]){
//   $('.primary-text').addClass("light-text").removeClass('primary-text');
// } else {
// $('.light-text').addClass("primary-text").removeClass('light-text');
// }
// });
